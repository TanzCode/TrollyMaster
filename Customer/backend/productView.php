...
include 'dbConnection.php'; // Assumes you have a dbConnection.php file to connect to your database
...
<div class="product-view">
    <div class="product-details">
        ...
        <img src="../../Seller/backend/<?php echo $product['image']; ?>" alt="<?php echo $product['name']; ?>">
    </div>
